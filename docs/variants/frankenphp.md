...
Laravel Octane variant powered by **[FrankenPHP](https://frankenphp.dev/)**. The container keeps a long-running PHP worker pool warm, eliminating per-request boot overhead.
